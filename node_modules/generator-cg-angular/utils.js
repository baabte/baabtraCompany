...
exports.processTemplates = function(name,dir,type,that,defaultDir,configName,module){
    ...
    _.chain(fs.readdirSync(templateDirectory))
        ...
        .each(function(template){
            var customTemplateName = type + '-' + template.replace(type.toLowerCase(),name);
...
exports.askForDir = function(type,that,module,ownDir,cb){
    ...
    var dirPromptCallback = function (props) {
        ...
        //the following line is edited by anoop to set the application folder structure
        var dirToCreate = 'angularModules/' + that.dir + type + 's/';

        //the following line is added by anoop to set the application folder structure 
        that.dir =  dirToCreate;
