...
fg.config(["fgConfigProvider", "FgField", function (fgConfigProvider, FgField) {
  ...
  var categories = {
    ...
    'Other fields': [  /*updated by akshath for adding custom attributes*/
      ...
      //   displayName: "File"
      // }),new FgField('elementdescription',{ // added by jihin for course elements
...
angular.module('fg').run(['$templateCache','courseElementFieldsManaging','fgConfig','FgField','addCourseElementService', function($templateCache,courseElementFieldsManaging,fgConfig,FgField,addCourseElementService){
  ...
  $templateCache.put('angular-form-gen/field-templates/default/div.ng.html','<div class=\"form-control contentEditDiv\"   fg-field-input=\"\" fg-placeholder=\"field.schema.placeholder\" ng-model=\"form.data[field.schema.name]\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"/{{ field.schema.validation.pattern }}/\"></div>\n' +
    '</div>');
  $templateCache.put('angular-form-gen/field-templates/default/file.ng.html', '<input fg-custom-attributes type=\"text\" readonly=\"\" class=\"form-control m-b\" ><input type=\"file\" palceholder=\"please choose a image\" ng-file-select=\"form.data[field.schema.name] = $files[0]\" ng-model=\"form.data[field.schema.name]\" ng-multiple=\"false\" accept=\"*.img\" resetOnClick=\"true\">');

  //<input  class=\"form-control m-b-lg\" float-label wrapperless = "true" fg-field-input=\"\" type=\"file\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" ng-file-select=\"$parent.onFileSelect($files)\" ng-file-select  ng-file-change=\"$parent.fileSelected($files, $event)\" ng-multiple=\"false\" accept=\"image/*,*.pdf,*.xml\" resetOnClick=\"true\" ng-model=\"$parent.myFiles\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\"placeholder=\"{{ field.schema.displayName }}\" ng-pattern=\"/{{ field.schema.validation.pattern }}/\" ng-disabled=\"isDisabled(field.schema)\"><div class=\"m-v-xs form-group\"><i ng-hide=\"imageSrc\">No image chosen</i><img class=\"img-thumbnail img-responsive\" ng-src=\"{{imageSrc}}\" /><br/></div>
  $templateCache.put('angular-form-gen/field-templates/default/span.ng.html', '<span   class=\"form-control m-b-lg\" float-label wrapperless = "true" fg-field-input=\"\" fg-placeholder=\"field.schema.placeholder\" ng-model=\"form.data[field.schema.name]\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"/{{ field.schema.validation.pattern }}/\"></div>\n' +
    '</span>');
  ...
  $templateCache.put('angular-form-gen/form/field/field.ng.html', '<div class=\"fieldContainer m-t-xs p-md shadow-z-1 b-b pull-left col-xs-12\" ng-include=\"renderInfo.templateUrl\" index=\"$index\"></div>');
  ...
  // $templateCache.put('angular-form-gen/field-templates/default/elementdescription.ng.html', '<ng-quill-editor previewKey=\"description\" toolbar="true" link-tooltip="true" image-tooltip="true" toolbar-entries="font size bold list bullet italic underline strike align color background link image" editor-required="true" error-class="input-error" fg-field-input=\"\" type=\"text\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"{{ field.schema.validation.pattern }}\" ng-disabled=\"isDisabled(field.schema)\"></ng-quill-editor>');
  // $templateCache.put('angular-form-gen/field-templates/properties/elementdescription.ng.html', '<div fg-tabs-pane=\"Properties\"><div fg-property-field-common=\"{ fieldname: true, displayname: true, placeholder: true, tooltip: true }\"></div><div fg-property-field-value=\"\"><span class=\"form-control\" name=\"fieldValue\" ng-model=\"field.value\" ng-minlength=\"{{ field.validation.minlength }}\" strip-br=\"false\" no-line-breaks=\"true\" select-non-editable=\"true\" ng-maxlength=\"{{ field.validation.maxlength }}\" ng-pattern=\"{{ field.validation.pattern }}\"></div></div></div><div fg-tabs-pane=\"Validation\"><div fg-property-field-validation=\"{ required: true, minlength: true, maxlength: true, pattern: true }\"></div></div><div fg-tabs-pane=\"Custom Attributes\"><div fg-property-field-custom=\"\"></div></div>');
...
// ----------- numberField loader ends here -----------

// ----------- course Select Group -----------

$templateCache.put('angular-form-gen/field-templates/default/courseSelect.ng.html', '<course-selector fg-custom-attributes fg-field-input=\"\" type=\"text\"  id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\"placeholder=\"{{ field.schema.displayName }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" ng-disabled=\"isDisabled(field.schema)\"></course-selector>');


  $templateCache.put('angular-form-gen/field-templates/properties/courseSelect.ng.html', '<div fg-tabs-pane=\"Properties\"><div fg-property-field-common=\"{ fieldname: true, displayname: true, placeholder: true, tooltip: true }\"></div><div fg-property-field-value=\"\"><span class=\"\" name=\"fieldValue\" ng-model=\"field.value\" ng-minlength=\"{{ field.validation.minlength }}\" strip-br=\"false\" no-line-breaks=\"true\" select-non-editable=\"true\" ng-maxlength=\"{{ field.validation.maxlength }}\" ng-pattern=\"//{{ field.validation.pattern }}\"></div></div></div><div fg-tabs-pane=\"Validation\"><div fg-property-field-validation=\"{ required: true, minlength: true, maxlength: true, pattern: true }\"></div></div><div fg-tabs-pane=\"Custom Attributes\"><div fg-property-field-custom=\"\"></div></div>');

// ----------- course Select Group ends here -----------
...
fg.factory('fgUtils', ["$templateCache", "$window", "fgConfig","courseElementFieldsManaging" ,function ($templateCache, $window, fgConfig, courseElementFieldsManaging) {
