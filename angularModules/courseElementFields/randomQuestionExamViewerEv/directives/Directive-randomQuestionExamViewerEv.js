angular.module('baabtra').directive('randomQuestionExamViewerEv', function() {
	return {
		restrict: 'E',
		replace: true,
		scope: {
		...
		templateUrl: 'angularModules/courseElementFields/randomQuestionExamViewerEv/directives/Directive-randomQuestionExamViewerEv.html',
