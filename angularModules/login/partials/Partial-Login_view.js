...
angular.module('baabtra').controller('LoginViewCtrl',['$scope','$state','LoginService','localStorageService','$rootScope','commonService','$modal', 'bbConfig',function($scope,$state,LoginService,localStorageService,$rootScope,commonService,$modal,bbConfig){
...
$scope.loginSuccessCallback=function(data){
    ...
    //result: "false" $scope.logData.ActiveUserData.roleMappingObj.fkRoleId
